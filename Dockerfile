...
RUN VERSION=$(cat .env | grep VERSION= | head -n1| grep -o '".*"' | sed 's/"//g');sed -i "s/2019-01-15/Running: eif0\/k3cloud-docs:<a target=_blank href=https:\/\/google.de>v.$VERSION<\/a>/g" /static-site/public/about/index.html
